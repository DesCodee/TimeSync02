      ...
      {adding && (
        <View style={s.form}>
          ...
          <View style={s.colorRow}>
            {COLORS.map(c=>(
              <TouchableOpacity key={c} style={[s.colorDot,{backgroundColor:c},newColor===c&&s.colorDotSelected]} onPress={()=>setNewColor(c)} />
            ))}
          </View>
...
const s = StyleSheet.create({
  ...
  colorDotSelected:{transform:[{scale:1.3}],shadowColor:'#000',shadowOffset:{width:0,height:0},shadowOpacity:0.3,shadowRadius:4,elevation:4},
